...
/* Intakes the string of data, counts the number of students
then ensures each student has the correct number of grades.
*/
bool check_corrupt(const std::string values[], int size);

/*
  Intakes a student ID and field of values, returns an index with
